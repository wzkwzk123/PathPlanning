...
WINSIZE = [XDIM, YDIM]
EPSILON = 7.0 # one step extend distance
NUMNODES = 5000 # the node number in one tree

def dist(p1,p2):
    return sqrt((p1[0]-p2[0])*(p1[0]-p2[0])+(p1[1]-p2[1])*(p1[1]-p2[1]))

def step_from_to(p1,p2): # p1 initial point, p2 the goal point for the next step extend
